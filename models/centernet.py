...
from torchvision.models import mobilenet, resnet, mobilenet_v3_small, mobilenet_v3_large, inception_v3
import torch
...
class CenterNet(nn.Module):
    def __init__(self, num_classes=1, backbone="resnet18", upsample_mode="nearest", input_channels=3):
        super().__init__()
        # create backbone.
        ...
        if input_channels != 3:
            basemodel[0] = nn.Conv2d(input_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        # set basemodel
